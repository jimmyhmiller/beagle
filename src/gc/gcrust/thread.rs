...
use crate::gc::gcrust::roots::{FrameChain, RootSource};
use crate::gc::gcrust::type_info::TypeInfo;

use crate::gc::gcrust::barrier::SATBBuffer;
use crate::gc::gcrust::heap::Heap;
use crate::gc::gcrust::semi_space::PtrPolicy;
use crate::gc::gcrust::statemap::TraceState;
...
pub struct ThreadState {
    ...
    /// Used by [`Heap::pause_world`](crate::gc::gcrust::Heap::pause_world) to
