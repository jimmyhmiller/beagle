...
use super::{
    ...
    mark_and_sweep_v2::MarkAndSweepV2,
};
...
impl Allocator for GenerationV2 {
    fn new(options: AllocatorOptions) -> Self {
        let young = Space::new(DEFAULT_PAGE_COUNT * 10);
        let old = MarkAndSweepV2::new_with_page_count(DEFAULT_PAGE_COUNT * 100, options);
        Self {
            young,
            old,
            copied: vec![],
